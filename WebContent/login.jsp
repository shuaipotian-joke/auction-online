    ...
    <div class="login">
      <dl>
        ...
        <dd><label for="name">用户名：</label>
        	<input type="text" name="username" class="inputh" id="name"/></dd>
        <dd><label for="password">密 码：</label>
        	<input type="password" name="userpassword" class="inputh" id="password"/></dd>
        <dd>
        ...
        <dd class="buttom">
           ...
           <input id="register" name="" type="button" value="注 册" onclick="location='register.jsp'" class="spbg buttombg f14 lf" />
